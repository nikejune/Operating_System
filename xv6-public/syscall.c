...
extern int sys_th_create(void);
extern int sys_th_exit(void);
extern int sys_th_join(void);
...
[SYS_th_create] sys_th_create,
[SYS_th_exit] sys_th_exit,
[SYS_th_join] sys_th_join,
};
